...
def adapt_explanation(text):
    ...
    text = text.replace('Google Sheets and public hosting', 'Google Sheets synchronisation')
    text = text.replace('Public hosting and its access/persistence checks are still pending.', 'In this browser edition, review persistence depends on retaining browser site data; account-based access is not implemented.')
